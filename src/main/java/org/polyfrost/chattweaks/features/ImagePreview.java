...
public class ImagePreview {
    ...
    @Subscribe
    public void renderTickEvent(RenderEvent.Post event) {
        if (!ChatTweaks.config.imagePreview) return;
    ...
    private void handle(String value) {
        ...
        if (tex != -1) {
            ...
            if (!Keyboard.isKeyDown(Keyboard.KEY_LSHIFT)) scaleWidth *= ChatTweaks.config.imagePreviewWidth;
